package com.radiusnetworks.ibeaconreference.beacons.tools;

import com.radiusnetworks.ibeaconreference.beacons.RegionsProviderListener;
import com.radiusnetworks.ibeaconreference.utils.Tools;
...
public class BeaconRegionsFactory {
  ...
  public static void obtainRegionsToScan(RegionsProviderListener regionsProviderListener) {
    ...
    try {
      regionElevenCodeId = Tools.generateMd5(BEACONS_UUID+BEACON_ID_CONCAT_CHAR+BEACON_MAYOR_11);
      regionTenCodeId = Tools.generateMd5(BEACONS_UUID+BEACON_ID_CONCAT_CHAR+BEACON_MAYOR_10);
