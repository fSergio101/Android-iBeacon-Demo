...
import com.radiusnetworks.ibeaconreference.beacons.model.OrchextraBeaconMapper;
import com.radiusnetworks.ibeaconreference.beacons.model.OrchextraBeacon;
...
public class BeaconsController {
  ...
  public void onRegionEnter(Region region) {
    ...
    actionsSchedulerController.addAction();
    // - store enter
    region.getUniqueId();
